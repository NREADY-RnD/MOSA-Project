	...
	public static class CommandLineArguments
	{
		...
		private static List<Argument> GetMap()
		{
			var map = new List<Argument>()
			{
				...
				new Argument() { Name = "--optimizations-off", Setting = "Optimizations.Devirtualization", Value = "false"},
				...
				new Argument() { Name = "--Max", Setting = "Optimizations.Basic", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.SSA", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.ValueNumbering", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.SCCP", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.Devirtualization", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.LongExpansion", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.Platform", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.Inline", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.LoopInvariantCodeMotion", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.BitTracker", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.TwoPass", Value = "true"},
				new Argument() { Name = "--Max", Setting = "Optimizations.Inline.Maximum", Value = "15"},

				new Argument() { Name = "--Size", Setting = "Optimizations.Basic", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.SSA", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.ValueNumbering", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.SCCP", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.Devirtualization", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.LongExpansion", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.Platform", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.Inline", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.LoopInvariantCodeMotion", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.BitTracker", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.TwoPass", Value = "true"},
				new Argument() { Name = "--Size", Setting = "Optimizations.Inline.Maximum", Value = "3"},

				new Argument() { Name = "--Fast", Setting = "Optimizations.Basic", Value = "true"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.SSA", Value = "true"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.ValueNumbering", Value = "true"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.SCCP", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.Devirtualization", Value = "true"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.LongExpansion", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.Platform", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.Inline", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.LoopInvariantCodeMotion", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.BitTracker", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.TwoPass", Value = "false"},
				new Argument() { Name = "--Fast", Setting = "Optimizations.Inline.Maximum", Value = "0"},
			};
