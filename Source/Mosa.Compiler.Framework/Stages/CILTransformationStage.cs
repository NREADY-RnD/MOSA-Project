...
namespace Mosa.Compiler.Framework.Stages
{
	...
	public sealed class CILTransformationStage : BaseCodeTransformationStageLegacy
	{
		...
		/* I1 */ new ConversionEntry[] {
				...
				/* R4 */ new ConversionEntry(IRInstruction.ConvertR4ToInt32, IRInstruction.LogicalAnd32, 8),
				/* R8 */ new ConversionEntry(IRInstruction.ConvertR8ToInt32, IRInstruction.LogicalAnd32, 8),
		...
		/* I4 */ new ConversionEntry[] {
				...
				/* R4 */ new ConversionEntry(IRInstruction.ConvertR4ToInt32),
				/* R8 */ new ConversionEntry(IRInstruction.ConvertR8ToInt32),
		...
		/* I8 */ new ConversionEntry[] {
				...
				/* R4 */ new ConversionEntry(IRInstruction.ConvertR4ToInt64),
				/* R8 */ new ConversionEntry(IRInstruction.ConvertR8ToInt64),
		...
		/* U2 */ new ConversionEntry[] {
				...
				/* U4 */ new ConversionEntry(IRInstruction.LogicalAnd32, 16),
				/* U8 */ new ConversionEntry(IRInstruction.Truncation64x32, IRInstruction.LogicalAnd32, 16),
				/* R4 */ new ConversionEntry(IRInstruction.ConvertR4ToInt32, IRInstruction.LogicalAnd32, 16),
				/* R8 */ new ConversionEntry(IRInstruction.ConvertR8ToInt32, IRInstruction.LogicalAnd32, 16),
				/* I  */ new ConversionEntry(IRInstruction.LogicalAnd32, 16),
				/* U  */ new ConversionEntry(IRInstruction.LogicalAnd32, 16),
				/* Ptr*/ new ConversionEntry(IRInstruction.LogicalAnd32, 16)
				},
		...
		/* R4 */ new ConversionEntry[] {
				/* I1 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* I2 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* I4 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* I8 */ new ConversionEntry(IRInstruction.ConvertInt64ToR4),
				/* U1 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* U2 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* U4 */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* U8 */ new ConversionEntry(IRInstruction.ConvertInt64ToR4),
				/* R4 */ new ConversionEntry(IRInstruction.MoveR4),
				/* R8 */ new ConversionEntry(IRInstruction.ConvertR8ToR4),
				/* I  */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* U  */ new ConversionEntry(IRInstruction.ConvertInt32ToR4),
				/* Ptr*/ new ConversionEntry(IRInstruction.ConvertInt32ToR4)
				},
		/* R8 */ new ConversionEntry[] {
				/* I1 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* I2 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* I4 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* I8 */ new ConversionEntry(IRInstruction.ConvertInt64ToR8),
				/* U1 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* U2 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* U4 */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* U8 */ new ConversionEntry(IRInstruction.ConvertInt64ToR8),
				/* R4 */ new ConversionEntry(IRInstruction.ConvertR4ToR8),
				/* R8 */ new ConversionEntry(IRInstruction.MoveR8),
				/* I  */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* U  */ new ConversionEntry(IRInstruction.ConvertInt32ToR8),
				/* Ptr*/ new ConversionEntry(IRInstruction.ConvertInt32ToR8)
				},
