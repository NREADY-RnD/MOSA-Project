...
namespace Mosa.Compiler.Framework.Transform.Auto
{
	...
	public static class AutoTransforms
	{
		public static readonly List<BaseTransformation> List = new List<BaseTransformation> {
			...
			AutoInstance.IR_ConstantFolding_ConvertInt32ToR4,
			AutoInstance.IR_ConstantFolding_ConvertInt32ToR8,
			AutoInstance.IR_ConstantFolding_ConvertInt64ToR4,
			AutoInstance.IR_ConstantFolding_ConvertInt64ToR8,
			...
			AutoInstance.IR_Simplification_MoveInt32Propogation,
			AutoInstance.IR_Simplification_MoveInt64Propogation,
